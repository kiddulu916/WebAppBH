...
export const api = {
  ...
  updateTargetProfile(targetId: number, profile: { custom_headers?: Record<string, string>; rate_limits?: Array<{ amount: number; unit: string }> | Record<string, number>; account_enum?: import("@/types/schema").AccountEnumSettings; default_creds?: import("@/types/schema").DefaultCredsSettings }) {
