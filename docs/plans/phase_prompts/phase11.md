...
- **Vulnerability Sync**: Log findings like "Weak Password on MySQL" or "Vulnerable FTP Version" to the `vulnerabilities` table.
- **Alerting**: High-priority alerts for "RCE-capable" service vulnerabilities.
...
Deliverables: Dockerfile, Nmap-to-MSF wrapper script, and a service-specific attack decision tree.