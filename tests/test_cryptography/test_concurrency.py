# tests/test_cryptography/test_concurrency.py
import asyncio


def test_get_semaphores_returns_bounded_semaphores():
    from workers.cryptography.concurrency import get_semaphores
...
def test_tool_weights_contains_all_tools():
    ...
    expected_tools = {"TlsAuditor", "PaddingOracleTester", "PlaintextLeakScanner", "AlgorithmAuditor"}
