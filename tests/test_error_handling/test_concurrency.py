# tests/test_error_handling/test_concurrency.py
import asyncio


def test_get_semaphores_returns_bounded_semaphores():
    from workers.error_handling.concurrency import get_semaphores
...
def test_tool_weights_contains_all_tools():
    ...
    expected_tools = {"ErrorProber", "StackTraceDetector"}
