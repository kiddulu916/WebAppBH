"""Abstract base class for authentication tool wrappers."""
...
class AuthenticationTool(InfrastructureMixin, ABC):
    """Base class for all authentication tool wrappers.
    ...
    def parse_output(self, stdout: str) -> list:
        ...
        Returns:
            list[dict] with observation details for authentication findings
        """
