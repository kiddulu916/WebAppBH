...
Listens on ``identity_queue`` and runs the 5-stage identity management
...
async def main() -> None:
    """Entry point: listen on identity_queue forever."""
    container_name = get_container_name()
    logger.info("Identity Management starting", extra={"container": container_name})
