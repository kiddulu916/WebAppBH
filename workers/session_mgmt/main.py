...
Listens on ``session_queue`` and runs the 9-stage session management
...
async def main() -> None:
    """Entry point: listen on session_queue forever."""
    container_name = get_container_name()
    logger.info("Session Management starting", extra={"container": container_name})
